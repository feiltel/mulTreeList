    ...
    public View getConvertView(final Node node , int position, View convertView, ViewGroup parent)
    {
       ...
       final ViewHolder viewHolder ;
        if (convertView == null) {
            ...
            //TODO
            viewHolder.checkTypeIm = (ImageView) convertView.findViewById(R.id.im_select_tree);
        ...
        viewHolder.checkTypeIm.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //TODO
        if (node.getCheckType()==0){
            viewHolder.checkTypeIm.setImageResource(R.drawable.ic_check_un_24dp);
        }else if (node.getCheckType()==1){
            viewHolder.checkTypeIm.setImageResource(R.drawable.ic_check_part_24dp);
        }else if (node.getCheckType()==2){
            viewHolder.checkTypeIm.setImageResource(R.drawable.ic_check_all_24dp);
        }
